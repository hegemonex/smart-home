...
public class Room {
    ...
    public void addGroup(DeviceGroup group) { deviceGroups.add(group); }
    public boolean removeGroup(DeviceGroup group) { return deviceGroups.remove(group); }
    public boolean isEmpty() { return deviceGroups.isEmpty(); }
    public int size() { return deviceGroups.size(); }
    public DeviceGroup getFirstGroup() { return deviceGroups.isEmpty() ? null : deviceGroups.get(0); }
