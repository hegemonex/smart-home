...
import annotations.DeviceInfo;
import district.house.devices.Device;
import district.house.devices.smartdevices.SmartLight;
...
public class ReflectionDemo {
    ...
    public static SmartLight createSmartLightViaReflection() throws Exception {
        ...
        Class<?> smartLightClass = Class.forName(
                "district.house.devices.smartdevices.SmartLight");
